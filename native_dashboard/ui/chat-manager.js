 ...
 */
import { invoke, errorLogger, escapeHtml, showToast, showConfirmDialog, settings, saveSettings, } from './shared.js';
// ============================================================================
// Memory Manager
// ============================================================================
...
export class ChatManager {
    ...
    connect() {
        ...
        try {
            ...
            invoke('get_ws_token').then(token => {
    ...
    cancelEdit(msgIdx, originalContent) {
        ...
        const actionsEl = msgEl.querySelector('.message-actions');
        if (contentEl)
            contentEl.innerHTML = this.formatMessage(originalContent);
        if (actionsEl)
...
ChatManager.MAX_IMAGE_SIZE = 5 * 1024 * 1024; // 5MB
