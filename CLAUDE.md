...
| --- | --- | --- | --- |
| Bot core | `bot.py`, `cogs/`, `utils/`, `config.py` | Python 3.14+ — discord.py, Anthropic Claude (`claude-opus-5`), Gemini, FAISS RAG, yt-dlp/spotipy | ~5,365 pytest |
...
| Native dashboard | `native_dashboard/` | Tauri 2 + TypeScript 6 — English UI, Korean product name/branding | 505 vitest + 109 Playwright |
