...
A **polyglot monorepo** for a production Discord AI bot (v3.4.13). One repo, four tech stacks:

| Area | Path | Stack | Tests |
| --- | --- | --- | --- |
| Bot core | `bot.py`, `cogs/`, `utils/`, `config.py` | Python 3.14+ — discord.py, Anthropic Claude (`claude-opus-4-8`), Gemini, FAISS RAG, yt-dlp/spotipy | ~5,068 pytest |
...
| Native dashboard | `native_dashboard/` | Tauri 2 + TypeScript 6 — Korean UI | 298 vitest + 72 Playwright |
