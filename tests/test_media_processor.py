...
"""
Unit Tests for Media Processor Module.
...
class TestLoadCachedImageBytes:
    ...
    def test_load_existing_file(self, tmp_path):
        ...
        test_file = scratch / "pytest_probe_media_processor.png"
...
class TestLoadCachedImageBytesContentProcessorModule:
    """Tests for load_cached_image_bytes function."""
...
class TestPilToInlineDataContentProcessorModule:
...
class TestPrepareUserAvatarContentProcessorModule:
    """Tests for prepare_user_avatar function."""
...
class TestTextExtensionsContentProcessorModule:
    """Tests for TEXT_EXTENSIONS constant."""
...
class TestTextMimesContentProcessorModule:
    """Tests for TEXT_MIMES constant."""
...
class TestProcessAttachmentsContentProcessorModule:
    """Tests for process_attachments function."""
...
class TestPilToInlineDataContentProcessorMore:
    """Tests for pil_to_inline_data function."""
...
class TestImageioAvailableContentProcessorMore:
