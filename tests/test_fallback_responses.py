...
class TestFallbackResponse:
    ...
    def test_create_with_defaults(self):
        ...
        from cogs.ai_core.fallback_responses import FallbackResponse, FallbackReason
...
class TestFallbackSystem:
    ...
    def test_get_by_intent_greeting(self):
        ...
        from cogs.ai_core.fallback_responses import FallbackSystem, FallbackReason
...
class TestGlobalFallbackSystem:
    ...
    def test_global_instance_is_fallback_system(self):
        ...
        from cogs.ai_core.fallback_responses import fallback_system, FallbackSystem
...
class TestGetFallbackResponse:
    ...
    def test_with_reason(self):
        ...
        from cogs.ai_core.fallback_responses import get_fallback_response, FallbackReason
