...
class TestCacheCleanup:
    ...
    def test_cleanup_expired_cache_removes_old(self):
        ...
        from cogs.ai_core.storage import _cleanup_expired_cache, _history_cache, CACHE_TTL
...
class TestInvalidateCache:
    ...
    def test_invalidate_cache_removes_entry(self):
        ...
        from cogs.ai_core.storage import invalidate_cache, _history_cache, _metadata_cache
...
class TestInvalidateAllCache:
    ...
    def test_invalidate_all_cache_clears(self):
        ...
        from cogs.ai_core.storage import invalidate_all_cache, _history_cache, _metadata_cache
...
class TestCleanupCache:
    ...
    def test_cleanup_cache_returns_count(self):
        ...
        from cogs.ai_core.storage import cleanup_cache, _history_cache, _metadata_cache
