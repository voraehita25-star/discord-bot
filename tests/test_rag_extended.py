...
class TestRAGConstants:
    ...
    def test_linear_search_thresholds(self):
        ...
        from cogs.ai_core.memory.rag import LINEAR_SEARCH_MIN_SIMILARITY, LINEAR_SEARCH_RELEVANCE_THRESHOLD
...
class TestMemorySystemSingleton:
    ...
    def test_singleton_is_memory_system(self):
        ...
        from cogs.ai_core.memory.rag import rag_system, MemorySystem
