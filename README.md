...
**Version:** 3.3.15 | **Python:** 3.14+ | **Tests:** 3,371 pytest ✅ + 189 vitest ✅ + 73 Playwright ✅ (e2e + axe a11y + visual regression) | **Native Extensions:** Rust + Go | **Dashboard:** document attach + persistent per-conversation doc memory + file editor + 3D UI polish | **Last Update:** May 28, 2026
