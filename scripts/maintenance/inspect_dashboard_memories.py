...
# Use a `with` block so the shared lock on the DB file is released
# promptly. On Windows the bot's writer (aiosqlite WAL) will be blocked
# from checkpointing while a stray reader keeps the file open.
