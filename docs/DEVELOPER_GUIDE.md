...
> **Total Files:** 124 Python test files (5,338 tests) + 21 vitest files (624 frontend tests) + 13 Playwright spec files (164 e2e + a11y + visual regression tests)
...
│   │       └── *.test.ts     # 21 vitest files total (624 tests)
│   ├── tests-e2e/            # Playwright (Chromium) — headless against the static UI (164 tests, incl. the history page)
